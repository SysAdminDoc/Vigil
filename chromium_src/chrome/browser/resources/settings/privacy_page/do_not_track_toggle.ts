...
export interface SettingsDoNotTrackToggleElement {
  $: {
    ...
    globalPrivacyControlToggle: SettingsToggleButtonElement,
  };
}
...
export class SettingsDoNotTrackToggleElement extends PolymerElement {
  ...
  declare prefs: {
    ...
    vigil_global_privacy_control_enabled: chrome.settingsPrivate.PrefObject,
  };
  ...
  private onGlobalPrivacyControlChange_(event: Event) {
    (event.target as SettingsToggleButtonElement).sendPrefChange();
  }
