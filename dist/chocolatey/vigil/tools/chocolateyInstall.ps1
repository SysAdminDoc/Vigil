...
$packageArgs = @{
  ...
  fileType       = 'EXE'
  url            = "$urlBase/ungoogled-chromium_145.0.7632.159-1.$version`_installer_x86.exe"
  url64bit       = "$urlBase/ungoogled-chromium_145.0.7632.159-1.$version`_installer_x64.exe"
